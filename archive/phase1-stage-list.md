# Phase 1 — development checklist (historical)

> **Status:** closed log of Phase 1 (Stages 1–4: prerequisites, repo
> skeleton, `@loam/core` foundations, prototype port). Every box is
> ticked. Kept for historical reference; not maintained. Active backlog
> lives in `stage-list.md` at repo root. Foundational decisions
> recorded here are now better captured in `docs/seed-format.md`,
> `docs/event-protocol.md`, and `docs/stack.md`.
